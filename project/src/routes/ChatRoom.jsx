...
const test = [
    {
        id : 6,
        who: false,
        body : "아니에요 감사하긴요ㅠㅠ 제가 더 감사하죠! 오늘은 꼭 이야기 할 사람이 필요했거든요! 채팅방개설자명 님의 소통방 제목을 본 순간 한치의 망설임도 없이 바로 들어올 수 밖에 없었달까요?",
        time : "오전 5 : 05" 
    },
    {
        id : 5,
    ...
    },
    {
        id : 3,
        who: false,
        body : "채팅방개설자명 님의 소통방 제목을 본 순간 한치의 망설임도 없이 바로 들어올 수 밖에 없었달까요?",
        time : "오전 5 : 03" 
    },
    {
        id : 2,
        who: true,
        body : "안녕하세요! 채팅방개설자명 입니다! 들어와주셔서 감사해요.",
        time : "오전 5 : 02" 
    },
    {
        id : 1,
        who: false,
        body : "안녕하세요! 처음 뵙겠습니다. 제 이름은 이영서에요",
        time : "오전 4 : 58" 
    },
]
